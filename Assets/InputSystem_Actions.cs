...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""RhythmPlayer"",
            ""id"": ""d1bc9fff-b035-4e0c-8d45-975124d28f75"",
            ""actions"": [
                {
                    ""name"": ""Lane 0"",
                    ""type"": ""Button"",
                    ""id"": ""a9d1648f-3a81-4d3e-8ba8-e9a3762850ce"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""Lane 1"",
                    ""type"": ""Button"",
                    ""id"": ""0f1834c1-f75d-4a7c-9009-3cf175de808c"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""Lane 2"",
                    ""type"": ""Button"",
                    ""id"": ""af032e6c-80c9-4b36-91bd-6c7249202809"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""Lane 3"",
                    ""type"": ""Button"",
                    ""id"": ""c8435ffb-c38a-4d42-9739-d0802438215e"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""882bd000-e822-4f88-967c-997e7c865935"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""54466cdc-2ee3-4435-b564-76a3737eeea3"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""f1a62e56-5709-4fd1-ba4f-0b53a92e8d36"",
                    ""path"": ""<Keyboard>/j"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""3f94ef5d-109f-429b-9bf0-22a757d0393b"",
                    ""path"": ""<Keyboard>/k"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        // RhythmPlayer
        m_RhythmPlayer = asset.FindActionMap("RhythmPlayer", throwIfNotFound: true);
        m_RhythmPlayer_Lane0 = m_RhythmPlayer.FindAction("Lane 0", throwIfNotFound: true);
    ...
    // RhythmPlayer
    private readonly InputActionMap m_RhythmPlayer;
    private List<IRhythmPlayerActions> m_RhythmPlayerActionsCallbackInterfaces = new List<IRhythmPlayerActions>();
    private readonly InputAction m_RhythmPlayer_Lane0;
    private readonly InputAction m_RhythmPlayer_Lane1;
    private readonly InputAction m_RhythmPlayer_Lane2;
    private readonly InputAction m_RhythmPlayer_Lane3;
    /// <summary>
    /// Provides access to input actions defined in input action map "RhythmPlayer".
    /// </summary>
    public struct RhythmPlayerActions
    {
        private @InputSystem_Actions m_Wrapper;
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public RhythmPlayerActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "RhythmPlayer/Lane0".
        /// </summary>
        public InputAction @Lane0 => m_Wrapper.m_RhythmPlayer_Lane0;
        /// <summary>
        /// Provides access to the underlying input action "RhythmPlayer/Lane1".
        /// </summary>
        public InputAction @Lane1 => m_Wrapper.m_RhythmPlayer_Lane1;
        /// <summary>
        /// Provides access to the underlying input action "RhythmPlayer/Lane2".
        /// </summary>
        public InputAction @Lane2 => m_Wrapper.m_RhythmPlayer_Lane2;
        /// <summary>
        /// Provides access to the underlying input action "RhythmPlayer/Lane3".
        /// </summary>
        public InputAction @Lane3 => m_Wrapper.m_RhythmPlayer_Lane3;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_RhythmPlayer; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="RhythmPlayerActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(RhythmPlayerActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="RhythmPlayerActions" />
        public void AddCallbacks(IRhythmPlayerActions instance)
        {
            if (instance == null || m_Wrapper.m_RhythmPlayerActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_RhythmPlayerActionsCallbackInterfaces.Add(instance);
        ...
        /// </remarks>
        /// <seealso cref="RhythmPlayerActions" />
        private void UnregisterCallbacks(IRhythmPlayerActions instance)
        {
            @Lane0.started -= instance.OnLane0;
            @Lane0.performed -= instance.OnLane0;
            @Lane0.canceled -= instance.OnLane0;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="RhythmPlayerActions.UnregisterCallbacks(IRhythmPlayerActions)" />.
        /// </summary>
        /// <seealso cref="RhythmPlayerActions.UnregisterCallbacks(IRhythmPlayerActions)" />
        public void RemoveCallbacks(IRhythmPlayerActions instance)
        {
            if (m_Wrapper.m_RhythmPlayerActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="RhythmPlayerActions.AddCallbacks(IRhythmPlayerActions)" />
        /// <seealso cref="RhythmPlayerActions.RemoveCallbacks(IRhythmPlayerActions)" />
        /// <seealso cref="RhythmPlayerActions.UnregisterCallbacks(IRhythmPlayerActions)" />
        public void SetCallbacks(IRhythmPlayerActions instance)
        {
            foreach (var item in m_Wrapper.m_RhythmPlayerActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_RhythmPlayerActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "RhythmPlayer" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="RhythmPlayerActions.AddCallbacks(IRhythmPlayerActions)" />
    /// <seealso cref="RhythmPlayerActions.RemoveCallbacks(IRhythmPlayerActions)" />
    public interface IRhythmPlayerActions
    {
        /// <summary>
        ...
        /// <summary>
        /// Method invoked when associated input action "Lane 1" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        ...
        /// <summary>
        /// Method invoked when associated input action "Lane 2" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        ...
        /// <summary>
        /// Method invoked when associated input action "Lane 3" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
